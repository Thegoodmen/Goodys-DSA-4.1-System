...
GDSA.advantages = [
    ...
    "Begabung für [Zauber]",
    "Beidhändig",
    "Beseelte Knochenkeule (Dämon)",
    "Beseelte Knochenkeule (Dschinn)",
    "Beseelte Knochenkeule (Elementargeist)",
    "Beseelte Knochenkeule (Totengeist)",
